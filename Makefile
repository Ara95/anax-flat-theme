...
# LESS and CSS
LESS 		 	= style.less default.less light.less color.less dark.less colorful.less font.less principle1.less principle2.less principle3.less tema1.less tema2.less tema3.less#style1.less #style2.less
...
# target : upgrade-grid - Upgrade Grid
 .PHONY: upgrade-grid
 upgrade-grid:
	@$(call HELPTEXT,@)
